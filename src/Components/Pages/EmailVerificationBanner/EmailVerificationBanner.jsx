...
const EmailVerificationBanner = () => {
    return (
        <div className='bg-gradient-to-r from-sky-400 via-sky-100 to-white flex justify-between items-center rounded-xl'>
            <div className='pl-20'>
                ...
                <div className='w-[50%] relative'>
                    <input className='px-5 py-3 rounded-full w-full' type="email" placeholder='Enater your email address' />
